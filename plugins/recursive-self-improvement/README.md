...
A Claude Code plugin that reviews your daily chat logs and writes improvement proposals in three categories: productivity, automation, and wellbeing.
...
3. If wellbeing enabled: asks off-track patterns
